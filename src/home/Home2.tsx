...
import { Grid, ThemeProvider, List, ListItem, ListItemIcon, ListItemText, ListItemProps, Chip, Card, CardContent, CssBaseline, Box, Button, Link, AppBar, Toolbar, IconButton, Avatar } from "@material-ui/core";
...
function Home() {
    ...
    return (
        <Fragment>
            ...
            <CssBaseline />
            <Grid container>
                <Grid item xs={12}><Nav {...props}/></Grid>
                <Grid item xs={12} sm={4}><Contact {...props}/></Grid> 
                <Grid item xs={12} sm={8}><Cv {...props}/></Grid>
            </Grid>
            {/* <Nav classes={classes} /> */}
...
function Contact(props: any) {
    let data = props.data
    return <Box className={props.contact}>
        <Avatar src="./images/bot.jpg"></Avatar>
        <List dense>
            <ListItem>
...
function Nav(props: any) {
    return <Box className={props.nav}>
        <Typography>Nav</Typography>
    </Box>
}

// Section with all the CV info
// e.g. bio, skills, experience
function Cv(props: any) {
    return <Box className={props.cv}>
